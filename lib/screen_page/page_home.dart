...
import 'package:slicing_ui_community/screen_page/page_category.dart';
import 'package:slicing_ui_community/screen_page/page_course.dart';
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/img.png'), // Ganti dengan path gambar sesuai kebutuhan
                        fit: BoxFit.cover,
                      ),
                    ),
                  );
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  switch (index) {
                    case 0:
                      ...
                      subTitle = '818 Courses';
                      icon = Icons.security;
                      break;
                    case 1:
                      title = 'Data Science';
                      subTitle = '444 Courses';
                      icon = Icons.cloud;
                      break;
                          ...
                          children: [
                            ...
                            if (icon != null) // Menambahkan icon jika tidak null
                              Icon(
                                icon,
                                size: 40,
                                color: Colors.blueGrey, // Warna ikon
                              ), // Ikon
                          ],
                        ),
                      ),
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: SizedBox(
                                ...
                                child: Image.asset(
                                  'assets/topcourse1.png', // Gambar Data Science
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '2004 Learners', // Jumlah learners Data Science
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.black,
                                        ),
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: SizedBox(
                                ...
                                width: double.infinity,
                                child: Image.asset(
                                  'assets/topcourse2.png', // Gambar Machine Learning
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8), // Jarak antara rating dan learners
                                      Text(
                                        '818 Learners', // Jumlah learners Machine Learning
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.black,
                                        ),
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: SizedBox(
                                ...
                                width: double.infinity,
                                child: Image.asset(
                                  'assets/topcourse3.png', // Gambar Mobile Learning
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8), // Jarak antara rating dan learners
                                      Text(
                                        '2003 Learners', // Jumlah learners Mobile Learning
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.black,
                                        ),
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: SizedBox(
                              ...
                              child: Image.asset(
                                'assets/topcourse1.png', // Gambar category1
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
